...
`,
    ...
    {
      title: "Funding Types",
      para: `Before teaching you how to raise capital, you must first identify the type of capital you are seeking. Understanding all the pros and cons of different capital sources can be confusing, and most founders don't really know why one capital source is better than another.
We will change everything for you. You are about to learn everything you need to know about the various forms of capital. No, it is not as exciting as watching a Marvel movie, but it costs more.
`,
      img: "fam5.png",
    },
    {
...
Startups are the same way. If you’re just getting started (the Seed Stage) you’ll be talking to different investors than if you have already raised money previously and are in the Expansion stage. These aren’t strict definitions, mind you, but just general guidelines a company goes through as they grow.
`,
      img: "fam9.png",
    },
    {
      ...
      para: `The seed stage is the most formative stage of a startup. It usually starts with an idea, but most early-stage startups looking to raise money have more than just an idea. You're already working on a product prototype, and you've started working with a business plan in mind. This is where you get customers. Investors in the
seed stage usually get their first money and often have some sort of connection or relationship with the founder. The investment is usually small because the idea is still in its infancy and you bet more on the overall concept than the actual company.
Key Requirements:
Business Plan
...
`,
    ...
    },
    {
      ...
      para: `Whether you need to expand your team, pay for product development, or just need to be self-sufficient, at some point you may need to look outside for capital input.
Fortunately, there are several ways to find funds.
Banking, federal, or state governments may be a good option for some companies, but this guide focuses on the different types of investors you can bring when you run out of these options: friends and family, angel investors, and venture capitalists. 
`,
      img: "fam14.png",
    },
    {
...
There are over 6,000 active angel investors in the India alone
...
This is one of the many benefits of equity crowdfunding: by asking your existing supporters to share you fundraise with their own networks, you open yourself up to the possibility of making connections that you may have previously thought were impossible.
`,
      img: "fam17.png",
    },
    {
